...
**Verified by:** `https://docs.chain.link/data-streams/reference/report-schema-v10` (accessed 2026-05-02), `https://docs.chain.link/data-streams/reference/report-schema-overview` (accessed 2026-05-02), `src/soothsayer/chainlink/v10.py` (the canonical decoder, including the field-layout docstring at lines 11-30), `src/soothsayer/chainlink/feeds.py:31-41` (the verified-by-correlation `XSTOCK_FEEDS` registry), the V1 weekend-bias panel in [`reports/v1b_chainlink_comparison.md`](../../../reports/v1b_chainlink_comparison.md).
