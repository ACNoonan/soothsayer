...
10. [Pyth Network: "Introducing Pyth Lazer"](https://www.pyth.network/blog/introducing-pyth-lazer-launching-defi-into-real-time) (historical Lazer-era post; product subsequently renamed to **Pyth Pro** — see [docs.pyth.network/lazer](https://docs.pyth.network/lazer) and canonical [`docs/sources/oracles/pyth_lazer.md`](../../docs/sources/oracles/pyth_lazer.md)) — *sub-second updates shipping 2026; the cadence assumption that makes `g(·)` tight is now real.*
11. [Pyth + MagicBlock perpetuals demo](https://legacy.pyth.network/blog/magicblock-and-lazer-powering-a-new-wave-of-speed-for-solana-defi) — *production case study of low-latency oracle consumption on Solana (note: page lives on legacy.pyth.network and references the Lazer-era product naming; current product page is "Pyth Pro").*
