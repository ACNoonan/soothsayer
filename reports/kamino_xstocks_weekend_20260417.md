...
*Generated 2026-04-26T16:08:51.611458+00:00; reserve config snapshot from 2026-04-26.*
...
Coverage and half-width comparison across the three methods that publish a coverage band: Soothsayer at τ=0.85 (deployment default), Soothsayer at τ=0.95 (stricter oracle-validation comparator), and a simple free-data heuristic (`Friday close ± max(|Chainlink tokenizedPrice − Friday close|)` over the V5 tape). Excess width is half-width minus the realized absolute move; positive values indicate over-protection, negative values indicate the band missed the move.
...
Cases where Soothsayer (τ=0.85) and Kamino-incumbent reach a *different* classification for the near-liquidation borrower. These are the cells the pitch deck is interested in:
...
**Decision divergence count this weekend: 8 of 8 symbols** on the near-liquidation borrower.
